...
export const buildResponseEventFor = (event: Event, payload: any = {} ) : Event => {
  return {
...
export const buildResponseEventErrorFor = (event: Event, errorType: EventErrorType, message?: EventMessage) : Event => {
    return {
...
export const buildBadProtocolFor = (event: any, missingProperty: string) : Event => {
